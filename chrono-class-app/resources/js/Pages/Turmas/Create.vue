                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="mt-8 border-t border-neutral-700 pt-6">
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    <div>
                                        <label for="nome" class="text-sm font-medium text-gray-300">Nome da Turma (Ex: E3 2024):</label>
                                    ...
                                    <div>
                                        <label for="periodo" class="text-sm font-medium text-gray-300">Período (Ex: Matutino):</label>
