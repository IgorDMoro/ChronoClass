...
const classes = computed(() =>
    props.active
        ? 'inline-flex items-center px-1 pt-1 border-b-2 border-orange-400 text-green dark:text-white font-semibold text-sm leading-5 focus:outline-none transition duration-150 ease-in-out'
