...
Route::middleware('auth')->group(function () {
    ...
    // Rotas disponíveis para todos os usuários autenticados (professores e alunos)
    ...
    Route::middleware('professor')->group(function () {
        ...
        // Grades — ações de criação/edição/exclusão (rotas específicas ANTES do wildcard)
    ...
    // Rota de visualização — wildcard APÓS as rotas específicas acima
